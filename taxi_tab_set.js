...
window.rDrvSet = function(d, t, nav, hdr) {
    try {
                ...
                '<div class="inp-group" style="margin-bottom:20px; border-bottom:1px dashed rgba(255,255,255,0.1); padding-bottom:20px;">' +
                    ...
                    '<div style="display:flex; gap:8px; flex-wrap:wrap; margin-top:10px;">' +
                        '<label style="display:flex; align-items:center; gap:8px; background:rgba(255,255,255,0.03); padding:12px 16px; border-radius:12px; border:1px solid rgba(255,255,255,0.08); cursor:pointer; flex:1; min-width:40%; font-size:0.85rem; font-weight:700;">' +
                            '<input type="checkbox" id="cb-ftype-pb" value="pb" '+(fTypes.indexOf('pb')!==-1?'checked':'')+' onchange="if(typeof window.toggleManualFuelBoxes===\'function\') window.toggleManualFuelBoxes()" style="accent-color:#f59e0b; width:18px; height:18px;"> Benzyna' +
                        '</label>' +
                        '<label style="display:flex; align-items:center; gap:8px; background:rgba(255,255,255,0.03); padding:12px 16px; border-radius:12px; border:1px solid rgba(255,255,255,0.08); cursor:pointer; flex:1; min-width:40%; font-size:0.85rem; font-weight:700;">' +
                            '<input type="checkbox" id="cb-ftype-on" value="on" '+(fTypes.indexOf('on')!==-1?'checked':'')+' onchange="if(typeof window.toggleManualFuelBoxes===\'function\') window.toggleManualFuelBoxes()" style="accent-color:#f59e0b; width:18px; height:18px;"> Diesel' +
                        '</label>' +
                        '<label style="display:flex; align-items:center; gap:8px; background:rgba(255,255,255,0.03); padding:12px 16px; border-radius:12px; border:1px solid rgba(255,255,255,0.08); cursor:pointer; flex:1; min-width:40%; font-size:0.85rem; font-weight:700;">' +
                            '<input type="checkbox" id="cb-ftype-lpg" value="lpg" '+(fTypes.indexOf('lpg')!==-1?'checked':'')+' onchange="if(typeof window.toggleManualFuelBoxes===\'function\') window.toggleManualFuelBoxes()" style="accent-color:#f59e0b; width:18px; height:18px;"> Gaz (LPG)' +
                        '</label>' +
                        '<label style="display:flex; align-items:center; gap:8px; background:rgba(255,255,255,0.03); padding:12px 16px; border-radius:12px; border:1px solid rgba(255,255,255,0.08); cursor:pointer; flex:1; min-width:40%; font-size:0.85rem; font-weight:700;">' +
                            '<input type="checkbox" id="cb-ftype-ev" value="ev" '+(fTypes.indexOf('ev')!==-1?'checked':'')+' onchange="if(typeof window.toggleManualFuelBoxes===\'function\') window.toggleManualFuelBoxes()" style="accent-color:#0ea5e9; width:18px; height:18px;"> Prąd (EV)' +
                        '</label>' +
                    '</div>' +
                '</div>' +
        ...
        html += '<div style="padding:10px 15px; margin-top:10px; margin-bottom:10px;">' +
            '<button class="btn" style="background:linear-gradient(135deg, #0ea5e9, #0284c7); color:#fff; padding:20px; font-size:1.1rem; border-radius:24px; font-weight:900; letter-spacing:1px; box-shadow:0 10px 30px rgba(14,165,233,0.3); width:100%; text-transform:uppercase; border:none; outline:none;" onclick="if(typeof window.dSaveUS===\'function\') window.dSaveUS()">💾 ZAPISZ USTAWIENIA</button>' +
        '</div>' +
        
        // Opcje Backup & Restore
        '<div style="display:flex; gap:12px; padding: 0 15px 25px 15px;">' +
            '<button class="btn" style="flex:1; background:#18181b; color:#0ea5e9; border:1px solid rgba(14,165,233,0.3); padding:16px; border-radius:20px; font-weight:800; font-size:0.85rem; box-shadow:none; outline:none;" onclick="if(typeof window.dExport===\'function\') window.dExport()">📤 KOPIA ZAPASOWA</button>' +
            '<label class="btn" style="flex:1; background:#18181b; color:#f59e0b; border:1px solid rgba(245,158,11,0.3); padding:16px; border-radius:20px; font-weight:800; font-size:0.85rem; box-shadow:none; text-align:center; cursor:pointer; margin-top:0; outline:none; display:flex; align-items:center; justify-content:center;">📥 PRZYWRÓĆ DANE<input type="file" style="display:none;" onchange="if(typeof window.dImport===\'function\') window.dImport(event)"></label>' +
        '</div>' +
